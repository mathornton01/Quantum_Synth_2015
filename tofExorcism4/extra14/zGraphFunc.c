/**CFile***********************************************************************
  ...
  FileName    [zGraphFuncs.c]

  PackageName [extra]

  Synopsis    [Graph operators.]

  Description [External procedures included in this module:
				<ul>
				<li> Extra_zddCliques()
				<li> Extra_zddMaxCliques()
				<li> Extra_zddIncremCliques()
				</ul>
			Internal procedures included in this module:
				<ul>
				<li> extraZddIncremCliques()
				</ul>
			Static procedures included in this module:
				<ul>
				</ul>
           
			The procedures were proposed by O.Coudert.
			See O. Coudert. Solving Graph Optimization Problems 
			with ZBDDs. Proc. of ED&T '97, pp. 224-228.
	      ]
  ...
  Revision    [$zGraphFuncs.c, v.1.2, November 25, 2000, alanmi $]
