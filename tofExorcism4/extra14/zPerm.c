/**CFile***********************************************************************
  ...
  Description [External procedures included in this module:
				<ul>
				<li> Extra_zddExistAbstract()
				<li> Extra_zddPermute()
				<li> Extra_zddChangeVars()
				<li> Extra_zddCofactor0()
				<li> Extra_zddCofactor1()
				</ul>
			Internal procedures included in this module:
				<ul>
				<li> extraZddExistAbstractRecur()
				<li> extraZddChangeVars()
				<li> extraZddCofactor0()
				<li> extraZddCofactor1()
				</ul>
			Static procedures included in this module:
				<ul>
				<li> extraZddPermuteRecur()
				<li> zddCheckPositiveCube()
				<li> cuddZddGetNodeIVO2()
