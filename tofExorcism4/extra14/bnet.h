/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: bnet.h,v 1.10 1998/09/13 23:07:42 fabio Exp fabio $]
...
/* the size of the buffer for one line  -alanmi */
...
/* dirty hack to make the reader process more than one network
   using the same range of bdd variables (useful for BLIF file verification) */
EXTERN void Bnet_ResetCounterOfBddVariables();
EXTERN char ** readList ARGS((FILE *fp, int *n)); /* I used this function outside  -alanmi */
EXTERN char	*CurPos;                              /* I used this variable outside  -alanmi */
