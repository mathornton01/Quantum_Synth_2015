/**CFile***********************************************************************
  ...
  Description [External procedures included in this module:
	       ...
	       Static procedures included in this module:
		    <ul>
		    <li> extraZddLitCount();
			<li> localMemManagerStart();
			<li> localMemManagerLinkNext();
			<li> localMemManagerDissolve();
		    </ul>
	      ]
  ...
  Revision    [$zLitCount.c, v.1.2, November 16, 2000, alanmi $]
