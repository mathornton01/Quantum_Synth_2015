/**CFile***********************************************************************
  ...
  Synopsis    [Specialized ISOP computation procedures.]

  Description [External procedures included in this module:
				<ul>
				<li> Extra_zddIsopCoverAllVars();
				<li> Extra_zddIsopCoverUnateVars();
				<li> Extra_zddIsopCoverRandom();
				<li> Extra_zddIsopCoverReduced();
				</ul>
			Internal procedures included in this module:
				<ul>
				<li> extraZddIsopCoverAllVars();
				<li> extraZddIsopCoverUnateVars();
				<li> extraZddIsopCoverReduced();
				</ul>
			Static procedures included in this module:
				<ul>
				<li> extraZddIsopCoverRandom();
				<li> extraGenerateRandomPermutation()
				<li> cuddHashTableQuitZdd2()
  ...
  Revision    [$zISOP.c, v.1.2, April 5, 2001, alanmi $]
