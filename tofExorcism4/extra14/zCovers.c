/**CFile***********************************************************************
  ...
  Synopsis    [Dot product and cross product for sets of subsets.]

  Description [External procedures included in this module:
				<ul>
				<li> Extra_zddPrimeProduct();
				<li> Extra_zddProductAlt();
				<li> Extra_zddCompatible();
				<li> Extra_zddIsopCover();
				<li> Extra_zddIsopPrintCover();
				<li> Extra_zddIsopCoverAlt();
				<li> Extra_zddDisjointCover();
				<li> Extra_zddResolve();
				<li> Extra_zddSelectOneCube();
				<li> Extra_zddCheckUnateness();
				</ul>
			Internal procedures included in this module:
				<ul>
				<li> extraZddPrimeProduct();
				<li> extraZddProductAlt();
				<li> extraZddCompatible();
				<li> extraZddResolve();
				<li> extraZddIsopCoverAlt();
				<li> extraDecomposeCover();
				<li> extraComposeCover();
				<li> extraZddSelectOneCube();
				</ul>
  ...
  Revision    [$zCovers.c, v.1.2, November 26, 2000, alanmi $]
