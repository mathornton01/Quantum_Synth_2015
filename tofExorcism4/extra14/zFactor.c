/**CFile***********************************************************************
  ...
  Synopsis    [ZDD procedures for factorization.]

  Description [External procedures included in this module:
				<ul>
				<li> Extra_zddFactoredFormLiterals();
				<li> Extra_bddFactoredFormLiterals();
				<li> Extra_zddLFLiterals();
				<li> Extra_zddQuickDivisor();
				<li> Extra_zddLevel0Kernel();
				<li> Extra_zddDivision();
				<li> Extra_zddCommonCubeFast();
				<li> Extra_zddMoreThanOnceCubeFast();
				<li> Extra_zddMakeCubeFree();
				<li> Extra_zddTestCubeFree();
				<li> Extra_zddCountLiteralsSimple();
				<li> Extra_zddMoreThanOneCube();
				<li> Extra_zddCombinationFromLevels();
				<li> Extra_zddCommonLiterals();
				<li> Extra_zddMoreThanOneLiteralSet();
				<li> Extra_zddMoreThanOneLiteral();
				</ul>
			Internal procedures included in this module:
				<ul>
				<li> extraZddMoreThanOneLiteral();
				</ul>
			Static procedures included in this module:
				<ul>
				<li> ddCommonLiterals();
				<li> ddMoreThanOneLiteralSet();
				</ul>
	      ]
  ...
  Revision    [$zFactor.c, v.1.2, September 2, 2001, alanmi $]
