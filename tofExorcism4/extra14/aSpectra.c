/**CFile***********************************************************************
  ...
  Synopsis    [Computation of Walsh, Haar, and Reed-Muller spectra from the BDD.]

  Description [External procedures included in this module:
				<ul>
				<li> Extra_bddWalsh();
				<li> Extra_bddReedMuller();
				<li> Extra_bddHaar();
				<li> Extra_bddHaarInverse();
				<li> Extra_addRemapNatural2Sequential();
				</ul>
			Internal procedures included in this module:
				<ul>
				<li> extraBddWalsh();
				<li> extraBddReedMuller();
				<li> extraBddHaar();
				<li> extraBddHaarInverse();
				<li> extraAddUpdateZeroCubeValue();
				<li> extraAddIteRecurGeneral();
				</ul>
  ...
  The theory underlying the current implementation has been developed in 
  ...
  Revision    [$aSpectra.c, v.1.2, August 6,8,20, 2001, alanmi $]
******************************************************************************/
